...
| <a name="input_rad-security_depreceated_assumed_role_arn"></a> [rad-security\_depreceated\_assumed\_role\_arn](#input\_rad-security\_depreceated\_assumed\_role\_arn) | Deprecated Rad Security Role that will assume the rad-security-connect IAM role you create to interact with resources in your account. This role will be removed in the future. | `string` | `"arn:aws:iam::955322216602:role/ksoc-connector"` | no |
