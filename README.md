...
| <a name="input_rad-security_role_name"></a> [rad-security\_role\_name](#input\_rad-security\_role\_name) | The name of the IAM role that Rad Security will assume | `string` | `"rad-security-connect"` | no |
